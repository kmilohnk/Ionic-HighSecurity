...
const routes = [
    ...
    {
        path: 'rondas',
        loadChildren: () => Promise.all(/*! import() | modals-rondas-rondas-module */[__webpack_require__.e("common"), __webpack_require__.e("modals-rondas-rondas-module")]).then(__webpack_require__.bind(null, /*! ./modals/rondas/rondas.module */ "./src/app/modals/rondas/rondas.module.ts")).then(m => m.RondasPageModule)
    },
    {
        path: '',
        redirectTo: '/login',
    ...
    {
        path: 'out',
        loadChildren: () => Promise.all(/*! import() | modals-out-out-module */[__webpack_require__.e("common"), __webpack_require__.e("modals-out-out-module")]).then(__webpack_require__.bind(null, /*! ./modals/out/out.module */ "./src/app/modals/out/out.module.ts")).then(m => m.OutPageModule)
    }
];
...
/* harmony import */ var _providers_api_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./providers/api.service */ "./src/app/providers/api.service.ts");
...
/* harmony import */ var _ionic_native_toast_ngx__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ionic-native/toast/ngx */ "./node_modules/@ionic-native/toast/__ivy_ngcc__/ngx/index.js");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"]],
        providers: [
            _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
            _providers_api_service__WEBPACK_IMPORTED_MODULE_9__["ApiService"],
            ...
            /* LocalNotifications, */
            _ionic_native_toast_ngx__WEBPACK_IMPORTED_MODULE_13__["Toast"],
            {
...
let AuthInterceptor = class AuthInterceptor {
    intercept(req, next) {
        const guard = JSON.parse(sessionStorage.getItem("guard"));
        /* console.table(guard) */
        if (guard) {
...
let ApiService = class ApiService {
    ...
    login(rut, password) {
        return this.http.post(this.apiUrl + '/auth/loginApp', { rut, password });
    }
    getGuardById() {
        return this.http.get(this.apiUrl + '/users/Guards');
    }
    register(data) {
        return this.http.post(this.apiUrl + '/news', data);
    }
    getGuardShift(id) {
        return this.http.get(this.apiUrl + '/shifts/guardShifts/' + id);
    }
    registerVisitor(data) {
        return this.http.post(this.apiUrl + '/visits', data);
    }
    getVisitors(id) {
        return this.http.get(this.apiUrl + '/visits/allVisit/' + id);
    }
    ...
    body: idGuard*/
    initShift(id, idClient, idGuard) {
        return this.http.put(this.apiUrl + '/shifts/init/' + id + '/' + idClient, { idGuard });
    }
    finalShift(id, idClient, idGuard) {
        return this.http.put(this.apiUrl + '/shifts/final/' + id + '/' + idClient, { idGuard });
    }
    ...
    report(dataReport) {
        ...
        return this.http.post(this.apiUrl + '/reports', dataReport);
    }
    outVisit(shiftId, visitId, out) {
        console.table({ shiftId, visitId, out });
        return this.http.put(this.apiUrl + '/visits/out/', { shiftId, visitId, out });
    }
};
...
/* harmony import */ var _ionic_native_toast_ngx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic-native/toast/ngx */ "./node_modules/@ionic-native/toast/__ivy_ngcc__/ngx/index.js");
...
let AuthService = class AuthService {
    constructor(api, router, ngZone, navController, toast) {
        this.api = api;
        this.router = router;
        this.ngZone = ngZone;
...
module.exports = __webpack_require__(/*! C:\Users\camil\Desktop\programas\Ionic-hs-proyect-develop\src\main.ts */"./src/main.ts");
